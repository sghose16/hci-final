...
import { Button, IconButton, Grid, Chip, Typography } from "@mui/material";
      ...
      return value.map((brand) => (
        <Grid item >
          <Chip
              ...
              deleteIcon={<IconButton size="small" style={{ color: 'white' }}><CloseIcon /></IconButton>}
              sx={{
                color: "white",
      ...
      return (
        <Grid item>
          <Chip
                ...
                deleteIcon={<IconButton size="small" style={{ color: 'black' }}><CloseIcon /></IconButton>}
                variant='outlined'
                sx={{
                  color: "black",
